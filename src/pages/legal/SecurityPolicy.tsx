...
const sections = [
  {
    title: '1. 基本方針',
    content: `株式会社HOLY（以下「当社」といいます）は、出張洗車・出張コーティングサービス「MobileWash」の運営にあたり、ユーザーの情報資産を適切に保護し、安全かつ信頼性の高いサービスを提供するため、以下の情報セキュリティ方針を定め、徹底いたします。`,
  },
  {
